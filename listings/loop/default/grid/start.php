...
<div
    class="col-md-<?php echo esc_attr($col)?> col-sm-<?php echo esc_attr($col)?> col-xs-12 col-xxs-12 stm-isotope-listing-item all <?php echo esc_attr( implode(' ', $classes) ); ?>"
